class FormHelperController < ApplicationController
  ...
  protected
    ...
    def build_date_time(param_base, param, param_date, param_time)
      ...
      param_base_hash[param] = "#{param_base_hash[param_date]} #{param_base_hash[param_time]}" unless param_base_hash[param_date].blank? and param_base_hash[param_time].blank?
