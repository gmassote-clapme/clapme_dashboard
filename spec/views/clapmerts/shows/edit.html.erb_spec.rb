...
RSpec.describe "clapmerts/shows/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit clapmerts_show form" do
    render

    assert_select "form[action=?][method=?]", clapmerts_show_path(@clapme_show), "post" do
